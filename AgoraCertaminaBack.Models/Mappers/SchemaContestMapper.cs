...
namespace AgoraCertaminaBack.Models.Mappers
{
    public static class SchemaMappers
    {
        ...
        public static ContestFieldDTO ToCustomFieldDTO(this Field field)
        {
            return new ContestFieldDTO
            {
                Id = field.Id,
                Name = field.Name,
            ...
            List<CatalogReferenceDTO> catalogs)
        {
            return new DataSchemaDTO
            {
                Id = schema.Id,
                SchemaName = schema.SchemaName,
                CustomerId = schema.OrganizationName,
                Fields = allFields
        ...
        public static CatalogReferenceDTO ToCatalogReferenceDTO(this CustomCatalogDTO catalog)
        {
